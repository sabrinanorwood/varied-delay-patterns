...
All post-survey completers with a condition assignment are included. Note: 79 respondents have no behavioral CSV (open question — see 02_clean_surveys). They still have a condition from the pre-survey so are included here; flag for sensitivity analysis if needed.
...
all_results |> kable() |> kable_classic()
...
pairwise_rq3 |> kable() |> kable_classic()
